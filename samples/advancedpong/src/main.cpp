...
public:
    ...
    void OnInitialize() {
        ...
        mPaddle1Node->AddComponent(new dt::MeshComponent("Paddle", "AdvancedPongPaddle", "mesh"));

        mPaddle2Node = mGameNode->AddChildNode(new dt::Node("paddle2"));
        mPaddle2Node->SetPosition(Ogre::Vector3(FIELD_WIDTH / 2 + 0.5, 0, 0));
        mPaddle2Node->AddComponent(new dt::MeshComponent("Paddle", "AdvancedPongPaddle", "mesh"));
